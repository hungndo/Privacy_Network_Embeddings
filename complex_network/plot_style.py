...
METHOD_COLORS = {
    ...
    # Same DP release as edge_flip_vem, different post-processing, so it gets
    # the edge-flip family's ALT shade rather than a colour of its own --
    # the pair should read as two readouts of one mechanism.
    "edge_flip_spectral":   C_EDGEFLIP_ALT,
    # ── Gaussian mechanism ────────────────────────────────────────────────
    "gaussian":             C_GAUSSIAN,
    # ── our method ────────────────────────────────────────────────────────
...
METHOD_ORDER_HINT = [
    "edge_flip", "edge_flip_vem", "edge_flip_spectral", "edge_flip_pure_dp",
    "edge_flip_approx_dp",
